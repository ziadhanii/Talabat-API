        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull); // يمكنك استخدام SetNull لتجنب حذف الطلبات إذا كان DeliveryMethodId null
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false) // اجعل OrderId غير قابل للتعريف
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade); // حذف OrderItems عند حذف الطلب
                });
